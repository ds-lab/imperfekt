...
class IntervariableHTMLReportGenerator:
        ...
        <div class="container">
            <header class="header">
                <div class="header-content">
                    <h1>📊 Intervariable Imperfection Analysis Report{f" - {title}" if title else ""}</h1>
                    <div class="metadata">
                        ...
                        <span class="badge">α = {self.analysis.alpha}</span>
    ...
    def _generate_row_statistics_section(self) -> str:
        ...
        if self.analysis.results.rs_overall_statistics is None:
            return self._generate_empty_section("📊 Row Statistics", "No row statistics available")
                ...
                empty_stats_content = f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>🔍 All-Null Rows Statistics</h3>
        ...
        if (
            ...
            try:
                ...
                plots_html = f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📈 Row Statistics Visualizations</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">📊 Row Statistics</h2>
            ...
            <div class="section-content">
                ...
                <div class="subsection">
                    <div class="subsection-header">
                        <h3>📋 Overall Row Completeness Statistics</h3>
                        <span class="subsection-chevron">▼</span>
                    </div>
                    <div class="subsection-content">
                ...
                <div class="subsection">
                    <div class="subsection-header">
                        <h3>📋 Case-Level Row Completeness Statistics</h3>
                        <span class="subsection-chevron">▼</span>
                    </div>
                    <div class="subsection-content">
                        <div class="table-container">
    ...
    def _generate_mcar_test_section(self) -> str:
        ...
        if self.analysis.results.mcar_results is None:
            return self._generate_empty_section("🎯 MCAR Test", "No MCAR test results available")
        ...
        try:
            ...
            if isinstance(little_test, dict):
                    ...
                    <div class="table-container">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Significant (α = {self.analysis.alpha})</td>
                                    <td>{significance_text}</td>
                                    <td>Statistical significance at α = {self.analysis.alpha}</td>
                                </tr>
                                <tr>
                ...
                <div class="info">
                    <strong>What this shows:</strong>
                    <p><em>This test evaluates whether data are “Missing Completely At Random” (MCAR).</em></p>
                    <ul>
                        <li>A significant result (p &lt; α) suggests that missingness is NOT completely at random.</li>
                ...
                mcar_content += f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>🧪 Little's MCAR Test Results</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
        ...
        if self.analysis.results.plots.mcar_upset_plot:
            try:
                ...
                upset_plot_html = f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📈 Co-Imperfection UpSet Plot</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🎯 MCAR Test</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                {mcar_content}
    ...
    def _generate_mar_mnar_test_section(self) -> str:
        ...
        if self.analysis.results.mar_mnar_results is None:
            return self._generate_empty_section(
                "🔬 MAR/MNAR Test", "No MAR/MNAR test results available"
            )
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🔬 MAR/MNAR Test</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                <div class="info">
                    <strong>What this shows:</strong>
                    <p><em>This analysis distinguishes between “Missing At Random” (MAR) and “Missing Not At Random” (MNAR).</em></p>
                    <ul>
                ...
                <div class="subsection">
                    <div class="subsection-header">
                        <h3>📋 Temporal MAR/MNAR Test Results</h3>
                        <span class="subsection-chevron">▼</span>
                    </div>
                    <div class="subsection-content">
                        <div class="table-container">
    ...
    def _generate_symmetric_correlation_section(self) -> str:
        ...
        content_parts.append(f"""
            <div class="info">
                ...
                <ol>
                    ...
                    <ul><li>Cramér’s V measures association strength:
                    <ul>
            ...
            try:
                ...
                if corr_heatmap:
                    ...
                    content_parts.append(f"""
                        <div class="subsection">
                            <div class="subsection-header">
                                <h3>📊 Imperfection Correlation Matrix</h3>
                                <span class="subsection-chevron">▼</span>
                            </div>
                            <div class="subsection-content">
                                <div class="plot-section">
        ...
        if self.analysis.results.sc_chi2_intervariable_matrix is not None:
            try:
                ...
                content_parts.append(f"""
                    ...
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>🧮 Chi-squared Test Results</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            <div class="table-container">
        ...
        if self.analysis.results.plots.sc_lag_scatter_plot:
            ...
            if plots_html:
                content_parts.append(f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📈 Symmetric Cross-Correlation Plots</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            {plots_html}
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🔄 Symmetric Correlation</h2>
                <span class="chevron">▼</span>
            </div>
    ...
    def _generate_asymmetric_correlation_section(self) -> str:
            ...
            if len(stats_content) > 0:
                content_parts.append(f"""
                    <div class="info">
                        ...
                        <ul>
                            <li>Mann–Whitney U tests compare observed values when the other variable is missing versus when it is observed.</li>
                    ...
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📊 Asymmetric Statistical Comparison</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            <div class="grid">
        ...
        if (
            ...
            if plots_html:
                content_parts.append(f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📈 Distribution Comparison Plots</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            {plots_html}
        ...
        if self.analysis.results.plots.ac_lag_scatter_plot:
            ...
            if plots_html:
                content_parts.append(f"""
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📈 Asymmetric Lagged Cross-Correlation</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            {plots_html}
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">⚖️ Asymmetric Correlation</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                {content}
