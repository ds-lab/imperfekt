    ...
    <div class="container">
        <header class="header">
            <div class="header-content">
                <h1>📊 Intravariable Imperfection Analysis Report{f" - {title}" if title else ""}</h1>
                <div class="metadata">
...
"""
    ...
    def _generate_column_statistics_section(self) -> str:
        ...
        if self.analysis.results.cs_overall_statistics is None:
            return self._generate_empty_section(
                "📊 Column Statistics", "No column statistics available"
            )
    ...
    def _generate_gap_statistics_section(self) -> str:
        ...
        if self.analysis.results.gs_gaps_observation_runs is None:
            return self._generate_empty_section("🔍 Gap Statistics", "No gap statistics available")
        ...
        if (
            ...
            try:
                            ...
                            if col in self.analysis.results.gs_gaps_df:
                                ...
                                if not col_gaps_df.is_empty():
                                    ...
                                    gaps_describe_tables += f"""
                                        <div class="plot-section">
                                            <div class="plot-header" onclick="togglePlot(this)">
                                                <h4>📊 Gap Statistics Summary - {col}</h4>
                                                <span class="plot-chevron">▼</span>
                                            </div>
                ...
                if gaps_describe_tables:
                    ...
                    <div class="subsection">
                        <div class="subsection-header">
                            <h3>📊 Gap Descriptive Statistics by Column</h3>
                            <span class="subsection-chevron">▼</span>
                        </div>
                        <div class="subsection-content">
                            {gaps_describe_tables}
    ...
    def _generate_gap_returns_section(self) -> str:
        ...
        if self.analysis.results.gr_gap_returns is None:
            return self._generate_empty_section(
                "🔄 Gap Returns Analysis", "No gap returns analysis available"
            )
        ...
        if self.analysis.results.gr_gap_kruskal:
            kruskal_content = """<div class='subsection'>
                        <div class='subsection-header'>
                            <h3>🧮 Kruskal-Wallis Test Results</h3>
                            <span class='subsection-chevron'>▼</span>
                        </div>
                        <div class="subsection-content">"""
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🔄 Gap Returns Analysis</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                <div class="info">
                <strong>What this shows:</strong>
                <p>A Kruskal–Wallis H test examines whether the first observation after a gap (the “gap return”) differs depending on the length of the gap:</p>
                <ul>
                    ...
                    <li>Predefined bins: {self.analysis.gr_gap_and_return_bins} (if None, quantiles [0.0, 0.125, …, 1.0] are used).</li>
                </ul>
                </div>
                ...
                <div class='subsection'>
                    <div class='subsection-header'>
                        <h3>📈 Gap Returns Analysis Plots</h3>
                        <span class='subsection-chevron'>▼</span>
                    </div>
                    <div class="subsection-content">
                        {plots_html}
    ...
    def _generate_markov_section(self) -> str:
        ...
        if (
            ...
            return self._generate_empty_section(
                "🔗 Markov Chain Analysis", "No Markov chain analysis available"
            )
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🔗 Markov Chain Analysis</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                <div class="info">
                ...
                <div class='subsection'>
                    <div class='subsection-header'>
                        <h3>📈 Markov Chain Visualizations</h3>
                        <span class='subsection-chevron'>▼</span>
                    </div>
                    <div class="subsection-content">
                        {plots_html}
    ...
    def _generate_autocorrelation_section(self) -> str:
        ...
        if (
            ...
            return self._generate_empty_section(
                "📈 Autocorrelation Analysis", "No autocorrelation analysis available"
            )
    ...
    def _generate_windowed_significance_section(self) -> str:
        ...
        if (
            ...
            return self._generate_empty_section(
                "🪟 Windowed Significance Analysis",
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🪟 Windowed Significance Analysis</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                <div class="info">
                    <strong>What this shows:</strong>
                    <p>Mann–Whitney U-tests compare values within a fixed time window around an imperfect timestamp against values outside the window:</p>
                    <ul>
                ...
                <div class='subsection'>
                    <div class='subsection-header'>
                        <h3>📋 Windowed Analysis Results</h3>
                        <span class='subsection-chevron'>▼</span>
                    </div>
                    <div class="subsection-content">
                        <div class="table-container">
                ...
                <div class='subsection'>
                    <div class='subsection-header'>
                        <h3>📈 Windowed Significance Plots</h3>
                        <span class='subsection-chevron'>▼</span>
                    </div>
                    <div class="subsection-content">
                        {plots_html}
    ...
    def _generate_datetime_section(self) -> str:
        ...
        if (
            ...
            return self._generate_empty_section(
                "🕐 DateTime Analysis", "No datetime analysis available"
            )
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🕐 DateTime Analysis</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                <div class="info">
