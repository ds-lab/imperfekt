    ...
    <div class="container">
        <header class="header">
            <div class="header-content">
                <h1>📊 Preliminary Analysis Report{f" - {title}" if title else ""}</h1>
                <div class="metadata">
...
"""
    ...
    def _generate_descriptive_statistics_section(self) -> str:
        ...
        if self.analysis.results.descriptive_stats.is_empty():
            return self._generate_empty_section(
                "📊 Descriptive Statistics", "No descriptive statistics available"
            )
    ...
    def _generate_normality_check_section(self) -> str:
                ...
                <div class="subsection-content">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li><em>Decision rule:</em> p &lt; α → reject normality; p ≥ α → no evidence against normality.</li>
                ...
                <div class="subsection-content">
                    <div class="info">
                        ...
                        <ul>
                            ...
                            <li><em>Decision rule:</em> p &lt; α → joint normality unlikely.</li>
                    ...
                    <div class="subsection-content">
                        ...
                        <div class="info">
                            ...
                            <ul>
                                ...
                                <li><em>Curved pattern:</em> concave up → right-skew (long right tail), concave down → left-skew (long left tail).</li>
        ...
        if not content_parts:
            return self._generate_empty_section(
                "🧪 Normality Tests", "No normality test results available"
            )
        ...
        <section class="section">
            <div class="section-header">
                <h2 class="section-title">🧪 Normality Tests</h2>
                <span class="chevron">▼</span>
            </div>
            <div class="section-content">
                {content}
    ...
    def _generate_autocorrelation_section(self) -> str:
        ...
        if not self.analysis.results.autocorrelation:
            return self._generate_empty_section(
                "🔄 Autocorrelation Analysis", "No autocorrelation results available"
            )
        ...
        if self.analysis.results.plots.autocorrelation_lag_plot:
            ...
            for (
                ...
                <div class="plot-section">
                    <div class="plot-header" onclick="togglePlot(this)">
                        <h4>📈 Autocorrelation Plot: {col}</h4>
                        <span class="plot-chevron">▼</span>
                    </div>
                    <div class="collapsible-plot">
                        {plot_html}
            ...
            <div class="subsection">
                ...
                <div class="subsection-content">
                    ...
                    <div class="info">
                        ...
                        <ul>
                            <li><em>Lag k &gt; 0:</em> positive values → persistence/clustering; negative → alternation/mean-reversion.</li>
        ...
        if not content_parts:
            return self._generate_empty_section(
                "🔄 Autocorrelation Analysis", "No autocorrelation data available"
            )
    ...
    def _generate_correlation_section(self) -> str:
        ...
        if self.analysis.results.correlation.is_empty():
            return self._generate_empty_section(
                "🔗 Correlation Analysis", "No correlation results available"
            )
        ...
        <section class="section">
            ...
            <div class="section-content">
                ...
                <div class="subsection-content">
                    ...
                    <div class="info">
                        <strong>What this shows:</strong>
                        <p><em>Linear association between numeric variables (Pearson’s r: −1 to 1).</em></p>
                        <ul>
                            <li><em>Magnitude:</em> |r| close to 1 → strong linear relationship; near 0 → weak/no linear relationship.</li>
                            <li><em>Sign:</em> positive → move together; negative → move in opposite directions.</li>
